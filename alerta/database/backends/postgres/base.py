    ...
    def create_alert(self, alert):
        insert = """
            INSERT INTO alerts (id, resource, event, environment, severity, correlate, status, service, "group",
                ...
                last_receive_time, update_time, history, enriched_data, properties, worker_status)
            VALUES (%(id)s, %(resource)s, %(event)s, %(environment)s, %(severity)s, %(correlate)s, %(status)s,
                ...
                %(last_receive_time)s, %(update_time)s, %(history)s::history[], %(enriched_data)s, %(properties)s, %(worker_status)s)
            RETURNING *
        """
